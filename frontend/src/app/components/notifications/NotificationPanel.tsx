  ...
  const notifications: Notification[] = [
    {
      ...
      message: "Job 'prod-api-gateway' has exceeded critical risk threshold (score: 8.7/10)",
    ...
    },
    {
      ...
      message: "Job modified without approval in production environment",
    ...
    },
    {
      ...
      message: "Job 'user-database' risk score increased from 4.2 to 6.8",
